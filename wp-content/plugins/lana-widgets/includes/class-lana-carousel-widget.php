...
class Lana_Carousel_Widget extends WP_Widget{
	...
	public function widget_admin_scripts() {
		...
		wp_localize_script( 'lana-carousel-widget', 'lana_widgets_ajax', array(
			'get_gallery_html_from_shortcode_nonce' => wp_create_nonce( 'lana_widgets_get_gallery_html_from_shortcode' )
		) );
	}
	...
	public function get_gallery_images_from_shortcode( $shortcode ) {
		...
		$shortcode_image_ids = explode( ',', $shortcode_atts['ids'] );

		$attachments = get_posts( array(
			'include'        => $shortcode_image_ids,
			'post_status'    => 'inherit',
		...
		/** sort images */
		$images = array_replace( array_flip( $shortcode_image_ids ), $images );
	...
	public function form( $instance ) {
        ...
        <div class="lana-widgets-carousel-widget">
            ...
            <p>
                <input type="button" value="<?php esc_attr_e( 'Edit Gallery', 'lana-widgets' ); ?>"
